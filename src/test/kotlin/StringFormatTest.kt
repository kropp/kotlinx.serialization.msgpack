...
class StringFormatTest {
  ...
  fun shortString() {
    ...
    assertEquals("a", MessagePack.parse(String.serializer(), byteArray(0xda, 0x00, 0x01, 0x61)))
    assertEquals("a", MessagePack.parse(String.serializer(), byteArray(0xdb, 0x00, 0x00, 0x00, 0x01, 0x61)))
  }
  ...
  fun utf8() {
    ...
    val cyrillicBytes = byteArray(0xb2, 0xd0, 0x9a, 0xd0, 0xb8, 0xd1, 0x80, 0xd0, 0xb8, 0xd0, 0xbb, 0xd0, 0xbb, 0xd0, 0xb8, 0xd1, 0x86, 0xd0, 0xb0)
    val hiragana = "ひらがな"
