...
class StringFormatTest {
  ...
  fun shortString() {
    ...
    assertEquals("a", MessagePack.parse(String.serializer(), bytes(0xd9, 0x01, 0x61)))
    assertEquals("a", MessagePack.parse(String.serializer(), bytes(0xda, 0x00, 0x01, 0x61)))
    assertEquals("a", MessagePack.parse(String.serializer(), bytes(0xdb, 0x00, 0x00, 0x00, 0x01, 0x61)))
  }
  ...
  fun longString() {
    ...
    assertEquals(str, MessagePack.parse(String.serializer(), bytes(0xda, 0x00, 0x20, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30, 0x31, 0x32)))
  }
